...
#define STRING_CONFIG_H_AUTHOR "(Hetorus NL)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // run the PID calibration: M303 E0 S{temp} C8
  // run the PID calibration: M303 E0 S180 C8

  #define  DEFAULT_Kp 28.73
  #define  DEFAULT_Ki 1.33
  #define  DEFAULT_Kd 155.33
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 321.42
  #define  DEFAULT_bedKi 45.10
  #define  DEFAULT_bedKd 572.68
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2560, 925 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 4, 11 }
...
#define Y_MAX_POS 212 //Y_BED_SIZE
#define Z_MAX_POS 75
